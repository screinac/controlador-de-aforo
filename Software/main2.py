...
while ejecucion:
    ...
    elif (modo_ultrasonido == 2): #entrada - entrada - entrada - entrada
    ...
    elif (modo_ultrasonido == 3): #entrada - salida - salida - salida
    ...
    elif (modo_ultrasonido == 4): #salida - salida - salida - salida
    ...
    if((time.ticks_diff(time.ticks_ms(),timewrite)>5000) and (wp.isplaying==False)):
        timewrite=time.ticks_ms()
